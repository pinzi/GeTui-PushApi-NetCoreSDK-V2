...
namespace GeTuiPushApiV2.NetCoreSDK.Core.IOC
{
    /// <summary>
    /// 服务注册扩展类
    /// </summary>
    public static class ServiceCollectionExtensions
    {
        ...
        public static void UseGeTuiPushApiV2NetCoreSDKCore(this IServiceCollection services, StorageType storageType = StorageType.Redis)
        {
